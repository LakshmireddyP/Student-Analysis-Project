...
class DataTransformation:
    ...
    def get_data_transformer_obj(self):
        '''
        from this we get an object to fit data and get data transformation 
        '''
        logging.info("entered the data transform part")
    ...
    def initiate_data_transform(self,train_path,test_path):
        ...
        try:
            ...
            logging.info("the read of train and test data completed")
